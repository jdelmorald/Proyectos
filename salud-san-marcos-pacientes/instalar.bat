...
echo ==============================================
echo   Salud San Marcos - Gestion de Pacientes - Instalacion
...
echo ==============================================
echo   LISTO.
echo   - El modulo de Gestion de Pacientes ya esta corriendo en segundo plano, sin ventanas.
echo   - Arrancara solo cada vez que inicies sesion en esta PC.
echo   - Usa el acceso directo "Salud San Marcos - Pacientes" del Escritorio para abrirlo.
echo   - O entra directo desde el navegador a: http://localhost:4003
echo ==============================================
pause
goto :eof
