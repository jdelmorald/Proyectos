...
const GRUPOS = ['Comercial', 'Almacén y Logística', 'Administrativo'] as const;
    ...
    <div className="min-h-screen flex bg-slate-50">
      <aside className="no-print w-72 shrink-0 bg-white border-r border-slate-200 flex flex-col">
        <div className="px-5 py-4 border-b border-slate-200 flex flex-col items-center text-center gap-1">
          <img src={logo} alt="Indelderca" className="h-16 w-auto object-contain" />
          <div className="text-sm font-bold tracking-tight text-brand-900">INDELDERCA</div>
