...
echo ==============================================
echo   LISTO.
echo   - Indelderca ya esta corriendo en segundo plano, sin ventanas.
echo   - Arrancara solo cada vez que inicies sesion en esta PC.
echo   - Usa el acceso directo "Indelderca" del Escritorio para abrirlo.
echo   - O entra directo desde el navegador a: http://localhost:4001
echo ==============================================
pause
goto :eof
