-- Esquema de base de datos del sistema de documentos operativos de Salud San Marcos
...
CREATE TABLE IF NOT EXISTS activos (
  ...
  numero_serie TEXT,
  ubicacion TEXT,
  estado TEXT NOT NULL DEFAULT 'Operativo' CHECK (estado IN ('Operativo', 'En mantenimiento', 'Fuera de servicio', 'De baja')),
  responsable TEXT,
