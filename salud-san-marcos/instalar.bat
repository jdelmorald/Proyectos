...
echo ==============================================
echo   Salud San Marcos - Instalacion
...
echo ==============================================
echo   LISTO.
echo   - Salud San Marcos ya esta corriendo en segundo plano, sin ventanas.
echo   - Arrancara solo cada vez que inicies sesion en esta PC.
echo   - Usa el acceso directo "Salud San Marcos" del Escritorio para abrirlo.
echo   - O entra directo desde el navegador a: http://localhost:4002
echo ==============================================
pause
goto :eof
