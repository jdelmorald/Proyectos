...
import { SUPPLIER_TYPE_LABELS, SUPPLIER_STATUS_LABELS, RATING_FIELDS, RATING_LABELS } from "@/lib/suppliers";
...
export function SupplierForm({ supplier }: { supplier?: SupplierFormValues }) {
  ...
  return (
    <form action={formAction} className="bg-surface border border-line rounded-2xl p-5 sm:p-6 space-y-7">
      ...
      <div className="space-y-3.5 pt-2 border-t border-line">
        ...
        <div>
          ...
          <select
            id="status"
            name="status"
            defaultValue={supplier?.status ?? "POTENCIAL"}
            className={inputClass}
          >
        ...
        <div className="grid sm:grid-cols-2 gap-3.5">
          ...
          <div>
            ...
            <input
              id="minOrder"
              name="minOrder"
              defaultValue={supplier?.minOrder ?? ""}
              className={inputClass}
            />
          </div>
          <div className="sm:col-span-2">
