 ...
 * dorado/esmeralda (los acentos de marca), y el contorno real de Venezuela
 * (geometría exacta, no un dibujo a mano) como marca de agua grande que se
 * desplaza en un vaivén horizontal suave — nunca gira, así nunca deja de
 * leerse como un mapa. Todo en CSS/SVG (sin video ni canvas) para que cargue
 * instantáneo incluso en equipos modestos, y respeta prefers-reduced-motion.
 */
...
export default function AnimatedBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-[#070c16]">
      ...
      {/* Contorno de Venezuela: marca de agua grande, vaivén horizontal suave (nunca gira) */}
      <svg
